...
- `project_name`: the default docker compose project name (default: `nautobot_version_control`)
...
#14 naming to docker.io/nautobot-version-control/nautobot:latest-py3.7 done
```
...
ee90fbfabd77   nautobot-version-control/nautobot:latest-py3.7   "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_version_control_worker_1
b8adb781d013   nautobot-version-control/nautobot:latest-py3.7   "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_version_control_nautobot_1
d64ebd60675d   nautobot-version-control/nautobot:latest-py3.7   "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_version_control_docs_1
